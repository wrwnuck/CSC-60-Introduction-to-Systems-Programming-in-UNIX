...
void get_stats(driver_t driver_list[NRACERS], stats_t *race_stats){
	...
	race_stats -> average_best_times = race_stats -> average_best_times / NRACERS;
...
void get_median(driver_t driver_list[NRACERS], stats_t *race_stats){
	...
	if( NRACERS % 2){
		...
		race_stats -> median = (double) (driver_list[midpoint].best_time + driver_list[midpoint-1].best_time) / (double) 2;
	} 	
}
/*--------------------------------------------------------*/
